    ...
    public sealed class WorkspaceTests
    {
        public sealed class TheWorkspaceModel
        {
            ...
            private static readonly Workspace completeObject = new Workspace
            {
                ...
                Admin = true,
                SuspendedAt = new DateTimeOffset(2018, 5, 24, 12, 16, 48, TimeSpan.Zero),
                ServerDeletedAt = new DateTimeOffset(2017, 6, 20, 12, 16, 48, TimeSpan.Zero),
                DefaultHourlyRate = 0,
                DefaultCurrency = "USD",
