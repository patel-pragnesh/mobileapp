...
{
    public sealed class DatePickerMaxInclusiveDateTargetBinding : MvxAndroidTargetBinding<DatePicker, DateTimeOffset>
    {
        public const string BindingName = "MaxInclusiveDate";

        public DatePickerMaxInclusiveDateTargetBinding(DatePicker target) : base(target)
        {
        }
